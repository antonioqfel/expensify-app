...
// Every time something happens subscribe gets called.
store.subscribe(() => {
...
//     ...user,
//     location: 'Montreal',
//     age: 27 // I have to put age after ...user if I want to overwrite age
//     // If I put it before age:27 will be overwritten by the age from ...user
// });